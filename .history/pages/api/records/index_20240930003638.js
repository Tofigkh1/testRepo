...
import {
  ...
  handlerUserRecordGET, // Kullanıcıya özel kayıtları çekmek için eklendi
...
export default async function handler(req, res) {
  ...
  try {
    switch (req.method) {
      case METHOD.GET:
        // Kullanıcıya özel kayıtları çekmek için ID kontrolünü yaparak GET isteğini yönetiyoruz
        if (req.query.user) {
