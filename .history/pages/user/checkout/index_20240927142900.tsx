...
export default function index() {
  ...
  const [isLoggedIn, setIsLoggedIn] = useState(false);
    ...
    export default function AddressInput() {
      ...
      // Adres değiştirme fonksiyonu
      const handleAddressChange = (e) => {
        setAddress(e.target.value); // Input değerini lokal state'e güncelle
      };
    
      // Telefon numarası değiştirme fonksiyonu
      const handlePhoneChange = (e) => {
        setPhoneNumber(e.target.value); // Input değerini lokal state'e güncelle
      };
