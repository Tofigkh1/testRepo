...
<SimpleForm/>
               ...
               <div className='flex items-center justify-center mt-16'>
                   ...
                   <button
                      className={`w-11/12 h-11 ${(isRectVisible || isRectVisible2) && basketId > 0 && inputVal && inputPhoneNumber && phoneNumRegex && addressValid ? 'bg-textColorGreen' : 'bg-overlayColorGreen'} text-white rounded-sm`}
