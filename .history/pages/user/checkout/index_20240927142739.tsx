...
export default function index() {
  ...
  const [isLoggedIn, setIsLoggedIn] = useState(false);
    ...
    const handleInputChange = (e) => {
      ...
      // Different validation logic based on the input field
      switch (name) {
        case 'address':
          ...
          dispatch({
            type: "SET_ERROR",
            payload: isValidAddress ? '' : 'Invalid address format!',
          });
          break;
        case 'phoneNumber':
          const formattedPhone = formatPhoneNumber(value);
          dispatch({ type: "SET_PHONE_NUMBER", payload: formattedPhone });
          const isValidPhone = azerbaijanPhoneRegex.test(formattedPhone);
          dispatch({
            type: "SET_ERROR_NUMBER",
            payload: isValidPhone ? '' : 'Invalid phone number format!',
          });
          break;
        default:
          break;
