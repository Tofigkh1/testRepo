...
<Sidebar>
        <SidebarItem
          icon={<Image src={userProfileIcon} alt="profile icon" width={24} height={24} />}
          text="Your Profile"
          active={active === 1}
          onClick={() => {
            setActive(1);
        ...
        <SidebarItem
          icon={<Image src={basket} alt="basket icon" width={24} height={24} />}
          text="Your Basket"
          active={active === 2}
          onClick={() => {
            setActive(2);
        ...
        <SidebarItem
          icon={<Image src={YourOrders} alt="orders icon" width={24} height={24} />}
          text="Your Orders"
          active={active === 3}
          onClick={() => {
            setActive(3);
        ...
        <SidebarItem
          icon={<Image src={ShoppingCheck} alt="checkout icon" width={24} height={24} />}
          text="Checkout"
          active={active === 4}
          onClick={() => {
            setActive(4);
        ...
        <SidebarItem
          icon={<Image src={LogoutIcon2} alt="logout icon" width={24} height={24} />}
          text="Logout"
          active={active === 5}
