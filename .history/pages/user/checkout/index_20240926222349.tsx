...
<div className=' mt-6 ml-6'>
  ...
  <input
    ...
    name="address"
    value={user.address}
    onChange={handleChange}  // handleChange fonksiyonunu kullanarak address güncelleniyor.
    required
...
<div className='ml-6'>
  <input
    type="text"
    id="phoneNumber"
    name="phoneNumber"  // phoneNumber ismiyle güncelleniyor
    value={user.phoneNumber}
    onChange={handleChange1}  // handleChange1 fonksiyonunu kullanarak phoneNumber güncelleniyor.
    required
    className='w-11/12 h-14 p-5 rounded-md'
    placeholder='+994'
  />
