...
export default function ProductsDetail() {
    ...
    className={`animatedButton rounded-full w-10 h-10 ${isRectVisible ? 'bg-textColorGreen' : ''}`}>
    30
</button>
<button
    onClick={() => dispatch(toggleRectVisible2())}
    className={`animatedButton rounded-full w-10 h-10 ${isRectVisible2 ? 'bg-textColorGreen' : ''}`}>
    60
</button>
