                ...
                <>
                    ...
                    <div className="pt-44 flex justify-around items-center w-full">
                        ...
                        <div className=" flex gap-5">
                            {/* <button className="bg-textColorGreen rounded-full w-8 h-8">30</button> */}
                            <button onc className={`rounded-full w-8 h-8 ${isRectVisible2 ? 'bg-textColorGreen' : ''}`}>30</button>
                            <button className={`rounded-full w-8 h-8 ${isRectVisible ? 'bg-textColorGreen' : ''}`}>30</button>
                            {/* <button className="bg-textColorGreen rounded-full w-8 h-8">60</button> */}
                        </div>
                    </div>
