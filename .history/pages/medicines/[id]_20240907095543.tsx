...
>
    <span
        className={`absolute inset-0 bg-textColorGreen transition-transform duration-300 ease-in-out ${isRectVisible ? 'scale-100 opacity-100' : 'scale-0 opacity-50'}`}
...
>
    <span
        className={`absolute inset-0 bg-textColorGreen transition-transform duration-300 ease-in-out ${isRectVisible2 ? 'scale-100 opacity-100' : 'scale-0 opacity-50'}`}
        style={{ borderRadius: "50%" }}
    ></span>
    <span 
