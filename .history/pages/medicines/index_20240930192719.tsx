    ...
    <div>
      ...
      {isLoading ? (
        ...
        <div>
          ...
          <SimpleGrid columns={5} spacing={4} padding={4}>
            {(chooseCategory ? getProductsByCategory(chooseCategory) : products)?.map((product: any) => (
              <Box key={product.id} borderWidth="1px" borderRadius="lg" p={4} cursor="pointer" onClick={() => onDetail(product.id)}>
                <ProductCard {...product} />
              </Box>
            ))}
          </SimpleGrid>
