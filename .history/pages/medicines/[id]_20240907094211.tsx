...
export default function ProductsDetail() {
    ...
    className={`rounded-full w-10 h-10 ${isRectVisible ? 'bg-textColorGreen' : ''} transition-all duration-300`}
>
    30
</button>
<button 
    onClick={() => dispatch(toggleRectVisible2())}
    className={`rounded-full w-10 h-10 ${isRectVisible2 ? 'bg-textColorGreen' : ''} transition-all duration-400`}
>
    60
</button>
