...
function Medicines() {
  ...
  <Tag
    ...
    className="cursor-pointer category-tag" // className ekledik
    style={{ transition: 'background-color 0.3s ease', position: 'relative' }} // position: relative ekledik
    _hover={{ bg: '#26d6a1' }}
  >
    {category.name}
    {/* Çizgi için ek HTML gerek yok, sadece CSS ile halledeceğiz */}
  </Tag>
))}
