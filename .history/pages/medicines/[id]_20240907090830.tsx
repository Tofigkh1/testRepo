        ...
        <div className="relative h-auto w-auto">
            {isLoading ? ( 
               <div style={{
                ...
                className={`rounded-full w-10 h-10 ${isRectVisible ? 'bg-textColorGreen' : ''}`}>
                30
            </button>
            <button 
                onClick={() => dispatch(toggleRectVisible2())}
                className={`rounded-full w-10 h-10 ${isRectVisible2 ? 'bg-textColorGreen' : ''}`}>
                60
            </button>
                    ...
                    <div className="flex justify-around">
                        <h1 className="mt-2">We work in close partnership with our alente - inalteine the NHS. the military, majer private healtheare providers and GP practices.</h1>
