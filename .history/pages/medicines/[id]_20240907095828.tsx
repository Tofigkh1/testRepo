...
<button 
    ...
    className={`rounded-full w-10 h-10 transition-all duration-300 transform ${isRectVisible ? 'bg-textColorGreen scale-100 opacity-100' : 'scale-0 opacity-0'}`}
>
    30
</button>
...
<button 
    ...
    className={`rounded-full w-10 h-10 transition-all duration-300 transform ${isRectVisible2 ? 'bg-textColorGreen scale-100 opacity-100' : 'scale-0 opacity-0'}`}
>
    60
</button>
