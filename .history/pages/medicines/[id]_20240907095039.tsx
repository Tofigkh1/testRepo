...
>
    <span
        className={`absolute inset-0 bg-textColorGreen transition-transform duration-300 ease-in-out ${isRectVisible ? 'scale-100 bg-categorycolor' : 'scale-0 '}`}
...
>
    <span
        className={`absolute inset-0 bg-textColorGreen transition-transform duration-300 ease-in-out ${isRectVisible2 ? 'scale-100 bg-categorycolor' : 'scale-0 '}`}
        style={{ borderRadius: "50%" }}
    ></span>
