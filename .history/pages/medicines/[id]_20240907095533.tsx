...
>
    <span
        className={`absolute inset-0 transition-transform duration-300 ease-in-out ${isRectVisible ? 'scale-100' : 'scale-0'}`}
        style={{
            backgroundColor: isRectVisible ? 'rgba(40, 228, 197, 1)' : 'rgba(40, 228, 197, 0.5)',
            borderRadius: "50%",
        }}
    ></span>
    <span 
        className={`relative z-10 transition-opacity duration-300 ${isRectVisible ? 'opacity-100' : 'opacity-50'}`}
    >
        30
    </span>
</button>
...
>
    <span
        className={`absolute inset-0 transition-transform duration-300 ease-in-out ${isRectVisible2 ? 'scale-100' : 'scale-0'}`}
        style={{
            backgroundColor: isRectVisible2 ? 'rgba(40, 228, 197, 1)' : 'rgba(40, 228, 197, 0.5)',
            borderRadius: "50%",
        }}
    ></span>
    <span 
        className={`relative z-10 transition-opacity duration-300 ${isRectVisible2 ? 'opacity-100' : 'opacity-50'}`}
    >
        60
    </span>
</button>
