...
import { useDispatch, useSelector } from "react-redux";
import { toggleRectVisible, toggleRectVisible2 } from "../../Shared/Redux/Featuries/ButtonVisibility/buttonVisibilitySlice";
        ...
        <div className="relative h-auto w-auto">
            {isLoading ? ( 
               <div style={{
                ...
                className={`rounded-full w-8 h-8 ${isRectVisible2 ? 'bg-textColorGreen' : ''}`}>
                30
            </button>
            <button 
                onClick={() => dispatch(toggleRectVisible2())}
                className={`rounded-full w-8 h-8 ${isRectVisible ? 'bg-textColorGreen' : ''}`}>
                60
            </button>
