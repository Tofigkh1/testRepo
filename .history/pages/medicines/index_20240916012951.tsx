...
>
  ...
  {categories?.map((category: any) => (
    <Tag
      key={category.id}
      colorScheme={hoveredCategory === category.id ? "red" : "teal"}
      ...
      style={{
        position: 'relative',
        color: hoveredCategory === category.id ? '#26d6a1' : '#000', // hover rengini mavi yapmak için
        transition: 'color 0.3s ease',
        paddingBottom: '5px', // Çizginin altında görünmesi için boşluk
      }}
      _hover={{
        color: '#26d6a1', // Hover sırasında metin rengini değiştirme
      }}
      _before={{
        content: '""',
        position: 'absolute',
        ...
        left: '0',
        bottom: '0',
        backgroundColor: '#26d6a1', // Mavi çizginin rengi
        transition: 'width 0.3s ease',
      }}
      _hoverBefore={{
        width: '100%', // Hover sırasında çizgiyi tam genişletme
      }}
    >
      {category.name}
    </Tag>
