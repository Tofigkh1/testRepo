...
>
    <span
        className={`absolute inset-0 bg-textColorGreen transition-transform duration-300 ease-in-out ${isRectVisible ? 'scale-100 opacity-100' : 'scale-0 opacity-0'}`}
        style={{ borderRadius: "50%" }}
    ></span>
    <span
        className={`relative z-10 transition-transform duration-300 ease-in-out ${isRectVisible ? 'scale-100 opacity-100' : 'scale-0 opacity-0'}`}
    >
        30
    </span>
</button>
...
>
    <span
        className={`absolute inset-0 bg-textColorGreen transition-transform duration-300 ease-in-out ${isRectVisible2 ? 'scale-100 opacity-100' : 'scale-0 opacity-0'}`}
        style={{ borderRadius: "50%" }}
    ></span>
    <span
        className={`relative z-10 transition-transform duration-300 ease-in-out ${isRectVisible2 ? 'scale-100 opacity-100' : 'scale-0 opacity-0'}`}
    >
        60
    </span>
</button>
                    ...
                    <div className=" flex flex-col text-goldText font-bold">
                        ...
                        <h1 className="mr-28 pt-2 text-5xl text-medicineFont font-medium ">
                        {products?.price}₼
                        </h1>
                        ...
                        <div className="flex gap-10">
                            ...
                            <button onClick={() => push("/user/checkout")} className={styles.buyButton}>add to basket</button>
                        </div>
                    </div>
