...
export default function ProductsDetail() {
    ...
    className={`rounded-full w-10 h-10 ${isRectVisible ? 'bg-textColorGreen' : ''} transition-all duration-500`}
>
    30
</button>
<button 
    onClick={() => dispatch(toggleRectVisible2())}
    className={`rounded-full w-10 h-10 ${isRectVisible2 ? 'bg-textColorGreen' : ''} transition-all duration-500`}
>
    60
</button>
