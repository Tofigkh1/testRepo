    ...
    basketItems.forEach((item) => {
      if (!timers[item.id]) {
        ...
        setProgress((prevProgress) => ({
          ...prevProgress,
          [item.id]: 0, // Çubuğun başlangıç noktası (yüzde)
        }));
      }
    });
  }, [basketItems]);
      ...
      setTimers((prevTimers) => {
        ...
        Object.keys(updatedTimers).forEach((productId) => {
          if (updatedTimers[productId] > 0) {
            ...
            setProgress((prevProgress) => ({
              ...prevProgress,
              [productId]: ((60 - updatedTimers[productId]) / 60) * 100, // Çubuğun genişliği: 0'dan 100'e kadar
            }));
          } else {
