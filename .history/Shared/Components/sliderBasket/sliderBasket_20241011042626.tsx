...
const BasketMenu = () => {
  ...
  const handleAddFromBasket = (productId: string) => {
    const basketProduct: BasketPostDataType = {
      ...
      cover_url: "coverUrl",  // Resim URL'sini buraya ekleyebilirsin
      ...
      rest_id: "restId",      // Restoran ID'si veya benzer alan
      category_id: "categoryId", // Kategori ID'si
      allDescription: "All details about the product", // Tüm açıklama
      price: 100,             // Ürünün fiyatı      img_url: "imageUrl",    // Ürünün resim URL'si

      name: "Product name",   // Ürün ismi
      count: 1,               // Ürün adedi
