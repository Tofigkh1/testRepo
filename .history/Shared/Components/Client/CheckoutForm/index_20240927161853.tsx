...
const SimpleForm: React.FC = () => {
  ...
  const [reducerState, dispatch] = useReducer(reducer, initialState); // Renamed 'state' to 'reducerState'
  ...
  return (
    <div>
      <Formik
  initialValues={{
    phoneNumber: user.phoneNumber || '', // Redux'tan gelen user state'ini formun başlangıç değerleri olarak geçin
      ...
      <div className={div}>
        <div className={inpdiv}>
          ...
          <Field
            ...
            id="phoneNumber"
            name="phoneNumber"
            value={values.phoneNumber} // Formik'in form state'ini kullanın
            onChange={(e) => {
              const formattedPhone = formatPhoneNumber(e.target.value);
              setFieldValue('phoneNumber', formattedPhone); // Formik state'ini güncelleyin
            }}
            placeholder="+994"
        ...
        <div className={inpdiv}>
          ...
          <Field
            ...
            id="address"
            name="address"
            value={values.address} // Formik'in form state'ini kullanın
            onChange={handleChange} // Formik'in handleChange'ini kullanarak güncelleme yapın
