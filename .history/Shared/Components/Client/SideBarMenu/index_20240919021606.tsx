      ...
      >
        <div className="p-4 pb-2 flex justify-between items-center">
          ...
          <h1
            ...
            className={`overflow-hidden transition-all mt-14 ${
...
export function SidebarItem({ icon, text, active, onClick }: SidebarItemProps) {
  ...
  return (
    <li
      ...
      className={`group relative flex items-center py-2 px-3 my-1 font-medium rounded-md cursor-pointer transition-colors gap-10 ${
        active
