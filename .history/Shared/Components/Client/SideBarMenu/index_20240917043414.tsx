...
// Iconlar
const userProfileIcon = "/userProfileIcon.svg";
const shoppingBag = "/shopping-bag.png";
const YourOrders = "/fulfillment.png";
const ShoppingCheck = "/ShoppingCheck3.png";
const LogoutIcon2 = "/exit.png";
