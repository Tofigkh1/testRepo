        ...
        <div className="p-4 pb-2 flex justify-between items-center">
          ...
          <h1
            ...
            className={`overflow-hidden transition-all  ${
              expanded ? "w-32 text-2xl font"  : "w-0" // Logo is hidden when sidebar is collapsed
            }`}
         ...
         >Menu</h1>
          ...
          <button
            ...
            className="p-1.5 rounded-lg bg-FooterColor hover:bg-mainRed mr-2 w-12 h-10 mt-14" 
          >
...
export function SidebarItem({ icon, text, active, onClick }: SidebarItemProps) {
  ...
  return (
    <li
      ...
      className={`group relative flex items-center py-2 px-3 my-1 font-medium rounded-md cursor-pointer transition-colors mt-5
          ${
        active
