...
export default function Sidebar({ children }: { children: ReactNode }) {
  ...
  return (
    <aside className="h-screen">
      <nav
        className={`h-full flex flex-col bg-white border-r border-whiteLight3 transition-all ml-5 ${
          expanded ? "w-[25%]" : "w-[100px] " // Sidebar expands to 32% width or collapses to 60px
        }`}
      >
