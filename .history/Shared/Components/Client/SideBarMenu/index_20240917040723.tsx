...
export function SidebarItem({ icon, text, active, alert }) {
  // SidebarContext'ten 'expanded' değerini alıyoruz
...
// App veya ana bileşen
function App() {
  return (
    <Sidebar>
      <SidebarItem icon={<ChevronFirst />} text="Dashboard" active />
      <SidebarItem icon={<ChevronLast />} text="Settings" />
    </Sidebar>
  );
}
