        ...
        <div className="p-4 pb-2 flex justify-between items-center">
         ...
         >Menu</h1>
          ...
          <button
            ...
            className="p-1.5 rounded-lg bg-textColorGreen hover:bg-clientButtonGreen mr-2 w-12 h-10 mt-14" 
          >
...
export function SidebarItem({ icon, text, active, onClick }: SidebarItemProps) {
  ...
  return (
    ...
    >
      ...
      {!expanded && (
        <span
          className={` absolute left-full whitespace-nowrap bg-overlayColorGreen text-black rounded-md py-1 px-2 transition-all duration-200 ml-2 opacity-0 group-hover:opacity-100`}
        >
          {text}
        </span>
      )}
