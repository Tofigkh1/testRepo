...
export default function BasketContainer(props: BasketProps) {
    ...
    // Mutation for clearing the basket
    const mutationClear = useMutation<BasketPostDataType, Error, BasketPostDataType>(
        (basketProduct: BasketPostDataType) => clearBasket(basketProduct),
        {
            ...
            onError: (error) => {
                ...
                toast({
                    title: `Error deleting basket: ${error.message}`,
                    status: 'error',
                    duration: 2000,
                    isClosable: true,
                    position: 'top-right',
                        ...
                        <div className="min-h-[550px] flex justify-between flex-col">
                            <div>
                                ...
                                <div className="flex justify-between items-center mb-5">
                                    ...
                                    <button onClick={handleClear} className={`lightRed gap-2 flex items-center capitalize ${styles.clear_btn}`}>
                                        <RemoveSvg />{t("clear all")}
                                    </button>
                                </div>
