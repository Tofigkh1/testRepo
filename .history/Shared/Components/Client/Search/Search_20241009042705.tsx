    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                // Map the products to match the ProductPostDataType structure
                const transformedProducts = products.map((product) => ({
                    ...product,
                    cover_url: product.cover_url || '', // Provide default or existing cover_url
                    created: product.created || new Date(), // Use the current date if missing
                    category_id: product.category_id || 0, // Provide a default category ID if missing
                    allDescription: product.allDescription || '', // Provide default or existing description
                }));
