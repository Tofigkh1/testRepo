        ...
        const fetchData = async () => {
            ...
            try {
                ...
                let products = response?.data?.result?.data.filter((product: PostDataType) => {
                    ...
                    ...product,
                    cover_url: product.img_url || '',  // Varsayılan değer
                    created: new Date().toISOString(),  // Varsayılan değer
                    category_id: 0,  // Varsayılan değer
                    allDescription: product.description || '',  // Varsayılan değer
                }));
