 ...
 interface BasketPostData {
    ...
    const handleAddFromBasket = (productId: string) => {
        const basketProduct: BasketPostDataType = {
            user_id: user?.id,  // Gerekli alanları buraya ekle
            product_id: productId,
            ageSize: isRectVisible ? "1" : isRectVisible2 ? "2" : null,
            // Diğer gerekli alanlar
            description: "Ürün açıklaması", // Örnek alan
            rest_id: "rest_id", // Örnek alan
            category_id: "category_id", // Örnek alan
            allDescription: "Tüm açıklama", // Örnek alan
        };
