 ...
 interface BasketPostData {
    ...
    const handleAddFromBasket = (productId: string) => {
        const basketProduct = {
            ...
            cover_url: "some_cover_url",  // Eksik alanları burada doldurmanız gerekiyor
            amount: 1,  // Örneğin, sabit bir değer olabilir
            created: new Date().toISOString(), // Tarih bilgisi
            count: 1,  // Ürünün sayısı
            price: 100, // Ürünün fiyatı
            name: "Product Name", // Ürünün adı
            allDescription: "Product description", // Ürün açıklaması
            id: productId, // Ürünün ID'si
        };
