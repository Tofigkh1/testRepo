...
const productPageCount = () => {
    ...
    const handleAddFromBasket = (productId: string) => {
        const basketProduct = {
            ...
            cover_url: items?.img_url || "",  // Ürünün görseli URL'si
            amount: items?.price || 1,        // Ürünün fiyatı
            created: new Date().toISOString(), // Ürünün eklenme zamanı
            count: items?.count || 1,         // Ürün adedi
