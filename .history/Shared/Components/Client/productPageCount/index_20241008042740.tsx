 ...
 interface BasketPostData {
    ...
    const handleAddFromBasket = (productId: string) => {
        const basketProduct: BasketPostData = {
            ...
            cover_url: "some_cover_url",
            amount: 1,
            created: new Date().toISOString(),
            count: 1,
            price: 100,
            name: "Product Name",
            allDescription: "Product description",
            id: productId,
            rest_id: "rest_id_value",  // Eklenmesi gereken değer
            category_id: "category_id_value",  // Eklenmesi gereken değer
            description: "Product description",  // Eklenmesi gereken değer
            img_url: "some_image_url"  // Eklenmesi gereken değer
        };
