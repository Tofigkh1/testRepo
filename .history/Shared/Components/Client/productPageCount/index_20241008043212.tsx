...
const productPageCount = () => {
    ...
    const user = useSelector((state: RootState) => state.products);
    ...
    const handleAddFromBasket = (productId: string) => {
        const basketProduct: BasketPostDataType = {
            ...
            cover_url: product.cover_url || "default_cover_url",
            ...
            rest_id: product.rest_id || "default_rest_id",
            category_id: product.category_id || "default_category_id",
            img_url: product.img_url || "default_img_url",
        };
