...
const OverlayPayment = () =>{
    ...
    return(
        ...
        <div className=' '>
         ...
         {isMenuOpen ?  <div className=' roun w-7/12 h-80 bg-white absolute z-50' style={{
                    left: '50%',          // Sol kenarı %50
                    top: '50%',           // Üst kenarı %50
                    transform: 'translate(-50%, -50%)', // Kendini %50 sola ve %50 yukarı kaydır
                }}>
                    <h1 className='text-center text-2xl font-semibold'> mehsulun almaq ucun zehmet olmasa bizimle elaqeye kecerek odenis edin!</h1>
